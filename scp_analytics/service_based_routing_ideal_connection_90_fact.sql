INSERT OVERWRITE TABLE service_based_routing_ideal_connection_90_fact
            ...
            if(cast(cutoff_unexp.cutoff_list_size as int) = 1,
                array(concat_ws('-','0','86400','1')),
                 if(cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string) as int) = 1,
                    if(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1 <=0 and 
                       cutoffs_exploded.cutoff_exp-5400 <=0,
                        if(cutoffs_exploded.cutoff_exp <> 0,
                           array(concat_ws('-','0',cast(cutoffs_exploded.cutoff_exp as string),'1'),
                                 concat_ws('-',cast(cutoffs_exploded.cutoff_exp+1 as string),
                                           cast(cutoffs_exploded.cutoff_exp -5400+86400 as string),'0'),
                                 concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1+86400 as string),'86400','1')),
                        ...
                        if(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1 > 0 and 
                         cutoffs_exploded.cutoff_exp-5400 <=0,
                          if(cutoffs_exploded.cutoff_exp-5400=0,
                             array(concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1 as string),'86400','0')),
                             array(concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1 as string),cast(pmod(cutoffs_exploded.cutoff_exp-5400+86400,86400) as string),'0'))
                             ),
                           if(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1]-5400+1 > 0 and 
                         cutoffs_exploded.cutoff_exp-5400 >0,
                             if(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1 > cutoffs_exploded.cutoff_exp-5400,
                               array(concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1 as string),'86400','1'),
                                     concat_ws('-','0',cast(cutoffs_exploded.cutoff_exp-5400 as string),'0')),
                               array(concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(cutoff_unexp.cutoff_list_size as int)-1] -5400+1 as string),cast(cutoffs_exploded.cutoff_exp-5400 as string),'0'))
                              ),
                             null
                           )
                        )
                       ),
                    if(cutoff_unexp.cutoff_list[cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string)-2 as int)] -5400+1 <=0 and cutoffs_exploded.cutoff_exp-5400 <=0,
                        array(concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string)-2 as int)] -5400+1+86400 as string),
                                           cast(cutoffs_exploded.cutoff_exp -5400+86400 as string),'0')),
                         if( cutoffs_exploded.cutoff_exp-5400 > 0 and 
                           cutoff_unexp.cutoff_list[cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string)-2 as int)] -5400+1 < 0,
                            array(concat_ws('-','0',cast(cutoffs_exploded.cutoff_exp-5400 as string),'0'),
                              concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string)-2 as int)] -5400+1 +86400 as string),'86400','0')
                              ),
                            if(cutoff_unexp.cutoff_list[cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string)-2 as int)] -5400+1 > 0 and cutoffs_exploded.cutoff_exp-5400 > 0,
                              if(cutoff_unexp.cutoff_list[cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string)-2 as int)] -5400+1 =1,
                                array(concat_ws('-','0',cast(cutoffs_exploded.cutoff_exp-5400 as string),'0')),
                                array(concat_ws('-',cast(cutoff_unexp.cutoff_list[cast(find_in_set(cutoffs_exploded.cutoff_exp,cutoff_unexp.cutoff_string)-2 as int)] -5400+1 as string),cast(cutoffs_exploded.cutoff_exp-5400 as string),'0'))
                                ),
                              null
                              )
                            )
