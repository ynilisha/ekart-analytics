INSERT OVERWRITE TABLE fc_pnl_rc_storage_revenue_l2_hive_fact 
select
a.inventory_item_warehouse_id as fc_pnl_rc_storage_warehouse,
b.fc_product_detail_hive_dim_key as fc_pnl_rc_storage_product_id_key,
a.date_key as fc_pnl_rc_storage_date_key,
sum(b.product_detail_volume*a.quantity*0.000578) as fc_pnl_rc_storage_space_utilized_in_cubic_feet,
sum(b.product_detail_volume*a.quantity*0.000578*c.fc_pnl_rate_inventory_storage/30) as fc_pnl_rc_storage_actual_space_used_revenue,
sum(a.quantity) as fc_pnl_rc_storage_units
...
and a.inventory_item_storage_location_type in 
('disposal_area',
'disposal_bulk',
