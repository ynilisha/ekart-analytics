INSERT OVERWRITE TABLE network_map_intermediate_fact
select distinct
source_id as srcfacilityid,
first_dest_id as transitfacilityid,
if(shiptype_mod ='NDD','PRIORITY',shiptype_mod) as shiptype,
destination_id as destfacilityid
from 
  (select 
  source_id,
  first_dest_id,
